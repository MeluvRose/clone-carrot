    ...
    <div className="mt-16 px-4">
      ...
      <div className="mt-16">
        <div className="flex flex-col items-center">
          ...
          <div className="grid border-b last:w-full mt-8 grid-cols-2 gap-16">
            <button
              className={cls(
        ...
        <form className="flex flex-col">
          ...
          <button
            className="mt-5 bg-orange-500 hover:bg-orange-600 text-white py-2 px-4 border border-transparent rounded-sm shadow-xm text-sm font-me
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 mt-6 gap-3">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium bg-white text-gray-500 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
